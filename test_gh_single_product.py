"""
Test Global House single product scraping
"""
import asyncio
import logging
...
async def test_single_product():
    """Test scraping a single Global House product"""
    scraper = GlobalHouseScraper()
    
    # Use one of the product URLs we found (with correct www subdomain)
    test_url = "https://www.globalhouse.co.th/product/CHiQ-%E0%B9%80%E0%B8%84%E0%B8%A3%E0%B8%B7%E0%B9%88%E0%B8%AD%E0%B8%87%E0%B8%9B%E0%B8%A3%E0%B8%B1%E0%B8%9A%E0%B8%AD%E0%B8%B2%E0%B8%81%E0%B8%B2%E0%B8%A8-Inverter-%E0%B8%82%E0%B8%99%E0%B8%B2%E0%B8%94-12000-BTU-%E0%B8%A3%E0%B8%B8%E0%B9%88%E0%B8%99-CSDC12D-%E0%B8%AA%E0%B8%B5%E0%B8%82%E0%B8%B2%E0%B8%A7-i.6972740282432"
    
    print("\n" + "="*60)
    print("Global House Single Product Test")
    print("="*60)
    ...
    try:
        ...
        if product:
            ...
            if product.features:
                ...
                for i, feature in enumerate(product.features[:3]):
                    print(f"    {i+1}. {feature}")
